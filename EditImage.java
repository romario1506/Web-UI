...
public class EditImage {
    ...
    public static void main(String[] args) {
        ...
        WebElement webElement2 = driver.findElement(By.name("Настройки"));
        webElement2.click();
        WebElement webElement3 = driver.findElement(By.name("Личные данные"));
        webElement3.click();
        WebElement webElement4 = driver.findElement(By.className("u1n25vdx"));
        webElement4.click();
        WebElement webElement5 = driver.findElement(By.name("Готово"));
        webElement5.click();
